...
abstract class CellPhone{
	...
	abstract void makeCall();				//makeCall function abstract so that to check for dual sim or single sim call
	public void makeSMS(){					//makeSMS function 
		System.out.println("enter your sms");
		message=scan.nextLine();
		System.out.println("******this was your sms*******\n"+message+"\n************\n\n");
	}
	public void makeMMS(){					// makeMMS function
...
class NewPhone extends CellPhone{                               // derives CellPhone properties
	...
	public void makeCall(){				//defination of makeCall function call are made according to sim slot selection
